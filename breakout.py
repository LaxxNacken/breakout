...
global block_position1
block_position1= [200, 150]
global block_position2
block_position2 = [250, 150]
...
def ball_collision():
    ...
    if ball_position[1] < 0 + 10:
        ball_move[1] *= -1
    if ball_position[1] > block_position1[1] - 10 and ball_position[0] > block_position1[0] and ball_position[0] < block_position2[0]:
        ball_move[1] *= -1 
...
def draw_stuff():
    ...
    pygame.draw.rect(window, pygame.Color(255, 255, 255), (block_position1[0], block_position1[1] , 80, 10))
